...
public class MainController {
   ...
   //오토닉스 서버 IP
   public static final String MAIN_IP = "192.168.1.184";
   public static final String SUB_IP = "192.168.1.184";
...
//       System.out.println("서브포트 : "+subPortCheck);
      ...
      if(mainPingCheck && mainPortCheck) {
         ...
         if(clientMain != null) {
            ...
            try {
               Map<String, Object> dataMap = opcDataMap.getOpcDataConnCheck(clientMain, "ace_posco.$SYSTEM$.$SystemStatus$");
...
//            System.out.println("tagValueMain : "+tagValueMain);
      ...
      if(subPingCheck && subPortCheck) {
         ...
         if(clientSub != null) {
            ...
            try {
               Map<String, Object> dataMap = opcDataMap.getOpcDataConnCheck(clientSub, "ace_posco.$SYSTEM$.$SystemStatus$");
