...
//            System.out.println("Failed to write value: " + statusCode);
   ...
   public void setOpcDataUShort(String opcGroup, int value) throws InterruptedException, ExecutionException {
       ...
       UShort uValue = Unsigned.ushort(value);   // UInt16 변환
       DataValue dataValue = new DataValue(new Variant(uValue));

       StatusCode statusCode = MainController.client.writeValue(nodeId, dataValue).get();

       if (!statusCode.isGood()) {
           throw new RuntimeException("OPC Write Failed: " + statusCode);
       }
   }
...
//            System.out.println("Failed to write value: " + statusCode);
   ...
   public void setOpcDataString(String opcGroup, String opcData) throws InterruptedException, ExecutionException {
       UShort namespaceIndex = Unsigned.ushort(2);
       NodeId nodeId = new NodeId(namespaceIndex, opcGroup);
       ...
       if (statusCode.isGood()) {
           System.out.println("[OPC Write - String] " + opcGroup + " = \"" + opcData + "\" ✅ 전송 성공");
       } else {
           System.err.println("[OPC Write - String] " + opcGroup + " 전송 실패 ❌ : " + statusCode);
       }
   }
   
   
   
   public void setOpcDataInt(String opcGroup, int opcValue) throws InterruptedException, ExecutionException {
       ...
       // int 값으로 Variant 생성
       DataValue dataValue = new DataValue(new Variant(opcValue));
       ...
       // 결과 확인
       if (statusCode.isGood()) {
           System.out.println("[OPC Write - Int] " + opcGroup + " = " + opcValue + " → 전송 성공");
           rtnMap.put("status", "OK");
       } else {
           System.out.println("[OPC Write - Int] " + opcGroup + " = " + opcValue + " → 전송 실패: " + statusCode);
           rtnMap.put("status", "NG");
       }
   }
   public void setOpcDataA(String opcGroup, String opcData) throws InterruptedException, ExecutionException{
      Map<String, Object> rtnMap = new HashMap<String, Object>();
...
//            System.out.println("Failed to write value: " + statusCode);
   ...
   public void setOpcDataA(String opcGroup, short opcData) throws InterruptedException, ExecutionException{
      Map<String, Object> rtnMap = new HashMap<String, Object>();
...
//            System.out.println("Failed to write value: " + statusCode);
   ...
   public void setOpcDataA(String opcGroup, boolean opcData) throws InterruptedException, ExecutionException{
      Map<String, Object> rtnMap = new HashMap<String, Object>();
