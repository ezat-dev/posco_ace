...
<body>
  <div class="container no-select">
    <div class="header">질소 가스 밸브</div>

    <div class="controls" style="margin-top:8px;">
      <button class="btn ctrl-btn" data-tag="gas-valve-off">OFF</button>
...
$.ajax({
   ...
   success: function(res) {
       if (res.status === "OK") {
           ...
           const onBtn = document.querySelector("[data-tag='gas-valve-on']");
           if (isOn) {
...
$.ajax({
   url: "/posco/monitoring/read/bit",
   type: "get",
   data: { tagName: "gas-valve-lamp-off" },
   success: function(res) {
       if (res.status === "OK") {
           const isOff = res.value === true;

           const offBtn = document.querySelector("[data-tag='gas-valve-off']");
           if (isOff) {
