...
<div class="container">
    ...
    <input type="text" class="input-hivacuum-2">
</div>
    </div>
...
$(document).ready(function () {
    ...
    loadAnalogValue("analog-hivacuum-pv-1", ".input-hivacuum-1");
    loadAnalogValue("analog-hivacuum-pv-2", ".input-hivacuum-2");
...
function savePopupValues() {
    ...
    const v1 = $(".input-hivacuum-1").val().trim();
    const v2 = $(".input-hivacuum-2").val().trim();
