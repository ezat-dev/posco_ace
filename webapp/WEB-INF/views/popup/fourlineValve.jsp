...
<body>
  <div class="container no-select">
    <div class="header">포라인 밸브</div>

    <div class="controls" style="margin-top:8px;">
      <button class="btn ctrl-btn" data-tag="fourline-valve-off">OFF</button>
	  <button class="btn ctrl-btn" data-tag="fourline-valve-on">ON</button>
...
$.ajax({
   ...
   success: function(res) {
       if (res.status === "OK") {
           ...
           const onBtn = document.querySelector("[data-tag='fourline-valve-on']");
           if (isOn) {
...
$.ajax({
   url: "/posco/monitoring/read/bit",
   type: "get",
   data: { tagName: "fourline-valve-lamp-off" },
   success: function(res) {
       if (res.status === "OK") {
           const isOff = res.value === true;

           const offBtn = document.querySelector("[data-tag='fourline-valve-off']");
           if (isOff) {
