...
<div class="container">
    ...
    <div class="header">히팅 SET 설정</div>

    <div class="box-wrap">
        <div class="row heat-inline">
    <label>히팅-SET</label>

    <input type="text" class="input-heat-1">

    <span class="unit-text">E</span>

    <input type="text" class="input-heat-2">
</div>
    </div>
...
$(document).ready(function () {
    ...
    loadAnalogValue("analog-heat-pv-1", ".input-heat-1");
    loadAnalogValue("analog-heat-pv-2", ".input-heat-2");
...
function savePopupValues() {
    ...
    const v1 = $(".input-heat-1").val().trim();
    const v2 = $(".input-heat-2").val().trim();
