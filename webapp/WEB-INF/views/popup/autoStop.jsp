...
<body>
  <div class="container no-select">
    <div class="header">자동운전 정지</div>

    <div class="controls" style="margin-top:8px;">
	  <button class="btn ctrl-btn" data-tag="auto-stop">정지</button>
...
$.ajax({
   ...
   type: "get",
   data: { tagName: "auto-stop-lamp" },
   success: function(res) {
       if (res.status === "OK") {
           const isOn = res.value === true;

           const onBtn = document.querySelector("[data-tag='auto-stop']");
           if (isOn) {
