...
<body>
  <div class="container no-select">
    <div class="header">진공로 히터</div>

    <div class="controls" style="margin-top:8px;">
      <button class="btn ctrl-btn" data-tag="vacuum-heat-off">OFF</button>
	  <button class="btn ctrl-btn" data-tag="vacuum-heat-on">ON</button>
...
$.ajax({
   ...
   success: function(res) {
       if (res.status === "OK") {
           ...
           const onBtn = document.querySelector("[data-tag='vacuum-heat-on']");
           if (isOn) {
...
$.ajax({
   url: "/posco/monitoring/read/bit",
   type: "get",
   data: { tagName: "vacuum-heat-lamp-off" },
   success: function(res) {
       if (res.status === "OK") {
           const isOff = res.value === true;

           const offBtn = document.querySelector("[data-tag='vacuum-heat-off']");
           if (isOff) {
