...
<body>
  <div class="container no-select">
    <div class="header">패턴 스킵</div>

    <div class="controls" style="margin-top:8px;">
	  <button class="btn ctrl-btn" data-tag="auto-skip-on">ON</button>
...
$.ajax({
   ...
   type: "get",
   data: { tagName: "auto-skip-lamp-on" },
   success: function(res) {
       if (res.status === "OK") {
           const isOn = res.value === true;

           const onBtn = document.querySelector("[data-tag='auto-skip-on']");
           if (isOn) {
