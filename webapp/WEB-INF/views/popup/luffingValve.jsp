...
<body>
  <div class="container no-select">
    <div class="header">저진공 밸브</div>

    <div class="controls" style="margin-top:8px;">
      <button class="btn ctrl-btn" data-tag="luffing-valve-off">OFF</button>
	  <button class="btn ctrl-btn" data-tag="luffing-valve-on">ON</button>
...
$.ajax({
   ...
   success: function(res) {
       if (res.status === "OK") {
           ...
           const onBtn = document.querySelector("[data-tag='luffing-valve-on']");
           if (isOn) {
...
$.ajax({
   url: "/posco/monitoring/read/bit",
   type: "get",
   data: { tagName: "luffing-valve-lamp-off" },
   success: function(res) {
       if (res.status === "OK") {
           const isOff = res.value === true;

           const offBtn = document.querySelector("[data-tag='luffing-valve-off']");
           if (isOff) {
