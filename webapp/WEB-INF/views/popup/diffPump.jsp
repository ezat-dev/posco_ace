...
<body>
  <div class="container no-select">
    ...
    <div class="controls" style="margin-top:8px;">
	  ...
	  <button class="btn ctrl-btn" data-tag="diff-pump-on">ON</button>
...
$.ajax({
   ...
   success: function(res) {
       if (res.status === "OK") {
           ...
           const onBtn = document.querySelector("[data-tag='diff-pump-on']");
           if (isOn) {
...
$.ajax({
   url: "/posco/monitoring/read/bit",
   type: "get",
   data: { tagName: "diff-pump-lamp-off" },
   success: function(res) {
       if (res.status === "OK") {
           const isOff = res.value === true;

           const offBtn = document.querySelector("[data-tag='diff-pump-off']");
           if (isOff) {
